...
<form:form method="post" modelAttribute="product" enctype="mutipart/form-data">
    <div class="form-floating mb-3 mt-3">
        <form:input type="text"  class="form-control" id="name" placeholder="Tên sản phẩm" path="productName" name="name" />
        <label for="name">Tên sản phẩm</label>
    </div>
    <div class="form-floating mb-3 mt-3">
        <form:input type="file"  class="form-control" id="file" placeholder="Tên sản phẩm" path="file" price="file" />
